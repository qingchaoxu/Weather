...
public class MyListView extends ListView implements OnScrollListener {
        ...
        if (isRefreshable) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    if (!isRecored) {
                        isRecored = true;
                        startY = (int) ev.getY();// record the status when refreshing
                    }
                    break;
    ...
    // when status changing, updata layout
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case REFRESHING:
                ...
                lvHeaderTipsTv.setText("refreshing waiting...");
                lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
                break;
            case DONE:
                headerView.setPadding(0, -1 * headerContentHeight, 0, 0);
                ...
                lvHeaderProgressBar.setVisibility(View.GONE);
                lvHeaderArrowIv.clearAnimation();
                lvHeaderArrowIv.setImageResource(R.drawable.dropdown);
                lvHeaderTipsTv.setText("refreshing");
                lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
                break;
        }
    ...
    public void onRefreshComplete() {
        state = DONE;
        lvHeaderLastUpdatedTv.setText("nearly updating:" + new Date().toLocaleString());
        changeHeaderViewByState();
    }
